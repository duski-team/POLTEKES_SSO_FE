<template>
  <div class="container-fluid">
    <div class="cara-box">
      ...
      <div class="bank">
        <div>BANK</div>
        <div><img src="@/assets/MANDIRILOGO.png" alt="" /></div>
      </div>
      <div class="bank">
        <div>Nama</div>
      ...
      <div v-if="cek.createdate != '000000'">
        <div @click="steps('ATM')" class="card-cara">
          ...
          <div v-if="step == 'ATM'" class="text-cara mt-4">
            <div class="text-cara-line">
              <p>1.</p>
              <p>Masukkan Kartu ATM dan PIN ATM.</p>
            </div>
            <div class="text-cara-line">
              <p>2.</p>
            ...
            <div class="text-cara-line">
              <p>7.</p>
              <p>Layar akan menampilkan konfirmasi. Jika sesuai, pilih Ya.</p>
            </div>
            <div class="text-cara-line">
              <p>8.</p>
              <p>
        ...
        <div @click="steps('IB')" class="card-cara">
          <div class="card-cara-button">
            <span>Mobile Banking Mandiri</span>
            <font-awesome-icon
              v-if="step == 'IB'"
              icon="fa-regular fa-square-caret-up"
            /><font-awesome-icon
